...
The API uses English stopwords for search optimization to filter out common words that don't contribute to search relevance. The stopword list is based on the [stopwords-en package](https://github.com/eandf/stopwords-en) and stored locally in `stopwords-en.json`.
